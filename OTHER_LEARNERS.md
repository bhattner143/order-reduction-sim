# Other learners (1–3) — not in the proposal

These earlier experiments are kept for reproducibility. They are **not** what
the URF / MV1 figure regenerates.

**Proposal learner:** [Learner 4](IMPLEMENTATION.md) · main [README](README.md).

The stronger sample-complexity speed claim from the 2026-07-01 meeting note is
**not** supported in the form stated there. That motivated Learner 4’s different
scoreboard (dominant lag + common soft probe), which *is* the URF evidence.

---

## Learner 1 — gradient curriculum on the three-lag cup
...
## Learner 2 — misspecification bias and two-timescale EKF
