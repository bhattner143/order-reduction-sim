...
# Historical note: Learners 1–3 (not in the proposal)

Earlier experiments tested a stronger sample-complexity reading of the
2026-07-01 meeting note. They are kept for reproducibility; they are **not**
what MV1 / `learner4-sim` regenerates.

**For Learners 1–3: that stronger speed claim is not supported in the form the
meeting note states it.** That motivated Learner 4’s different scoreboard
(dominant lag + common soft probe), which *is* the evidence used in the URF
draft.

## What was being claimed (Learners 1–3)
...
# Learner 4 detail (proposal learner)

See the top of this README and [`IMPLEMENTATION.md`](IMPLEMENTATION.md). Run:
